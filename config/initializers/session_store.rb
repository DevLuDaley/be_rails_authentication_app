...
if Rails.env === 'production' 
    ...
    Rails.application.config.session_store :cookie_store, key: '_be_rails_authentication_app', domain: 'http://localhost:3000/'
    # http://127.0.0.1:3000/
    # 'http://localhost:3000/api/v1/contracts'
  else
    Rails.application.config.session_store :cookie_store, key: '_be_rails_authentication_app'
